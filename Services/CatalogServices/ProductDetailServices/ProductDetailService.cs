...
namespace MultiShop.WebUI.Services.CatalogServices.ProductDetailServices
{
    public class ProductDetailService : IProductDetailService
    {
        ...
        public async Task<GetByIdProductDetailDto> GetByProductIdProductDetailAsync(string id)
        {
            ...
            {
                return new GetByIdProductDetailDto { ProductId = id, ProductDescription = "Ürün açıklaması bulunmuyor.", ProductInfo = "Ürün bilgisi bulunmuyor." };
            }
            try
            {
                var values = await responseMessage.Content.ReadFromJsonAsync<GetByIdProductDetailDto>();
                return values ?? new GetByIdProductDetailDto { ProductId = id, ProductDescription = "Ürün açıklaması bulunmuyor.", ProductInfo = "Ürün bilgisi bulunmuyor." };
            }
            catch
            {
                return new GetByIdProductDetailDto { ProductId = id, ProductDescription = "Ürün açıklaması bulunmuyor.", ProductInfo = "Ürün bilgisi bulunmuyor." };
